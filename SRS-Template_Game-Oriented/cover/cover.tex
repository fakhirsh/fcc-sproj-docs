...
\begin{titlepage}
    \centering
    \vspace*{0.5cm}
    \includegraphics[width=0.7\textwidth]{./images/fcc_logo} % Replace with the correct file path
    \vspace{2.5cm}
    ...
    \begin{center}
        ...
        \begin{tabular}{l l c}
            ...
            \textit{2012114} & \textit{Ali Zaman} & \raisebox{-1.0ex}{\rule{5cm}{.4pt}} \\[1cm]
            \textit{2112190} & \textit{Gul Khan} & \raisebox{-1.0ex}{\rule{5cm}{.4pt}} \\[1cm]
            \textit{2255487} & \textit{Timothius Gill} & \raisebox{-1.0ex}{\rule{5cm}{.4pt}} \\[1cm]
        \end{tabular}
        \end{center}
    \end{center}
